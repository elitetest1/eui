document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            main_title: "Elite UI",
            subtitle: "The enhanced experience of One UI 8.5",
            download_button: "View Devices",
            telegram_button: "Telegram",
            donations_button: "Donations",
            about_title: "What is Elite UI?",
            what_is_custom_rom: "A custom ROM based on One UI 8.5 is a modified version of Samsung's official software. It retains the core look and feel of One UI but adds new features, performance enhancements, and customizations that aren't available on the standard firmware. It's a way to get a fresh, optimized, and more powerful experience on your Galaxy device.",
            ...
            credits: "Credits to Tizziano Provenzano 'Elite', SAMSUNG (all) ExtremeROM (commits) @YACINEGTI, Ronoa Enzo🇦🇷 (testing and help) Ravindu🇱🇰 (tools and general help) Orangecat🇹🇭 (random build.prop tweaks shared in October 2024) oevrik🇷🇺 (ROM design) ExtremeXT🇷🇴 (for commits) Luminance🇻🇳 (ROM design) FPSensor🇦🇷 (kernel dev) Flopster🇦🇷 (kernel dev) Pritam🇮🇳 (Camera features) Matteo🇮🇹 (Tips, ideas, and general guides on various things. Thank you so much for all) Pablo🇦🇷 (emotional support) Nico Lopez 🇦🇷 (testing) LZTEAMPROJECT 🇧🇷 (ROM design) DevCore🇧🇪 (for helping boot UI8 and RIL fix) ",
            ...
            rom_install_step6: "Force reboot by holding POWER + Vol Down. The moment it reboots to a blank screen, hold Power + Vol Up to boot to Recovery (OFOX/TWRP). If shown the message to press something, press power, and quickly hold Power + Vol Up again, otherwise it won't boot to OFOX/TWRP.",
        ...
        es: {
            ...
            feature1_desc: "Integra todas las funciones de Inteligencia Artificial de la serie S23, porteadas directamente a tu dispositivo.",
            feature2_title: "Construido con Proton+",
            feature2_desc: "Kernel actualizado (upstreamed), con undervolt y GPU overclockeada (con voltaje de fábrica para la GPU).",
            ...
            credits: "Créditos a Tizziano Provenzano 'Elite', SAMSUNG (todos) ExtremeROM (commits) @YACINEGTI, Ronoa Enzo🇦🇷 (pruebas y ayuda) Ravindu🇱🇰 (herramientas y ayuda general) Orangecat🇹🇭 (ajustes aleatorios de build.prop compartidos en octubre de 2024) oevrik🇷🇺 (diseño de la ROM) ExtremeXT🇷🇴 (por commits) Luminance🇻🇳 (diseño de la ROM) FPSensor🇦🇷 (desarrollo del kernel) Flopster🇦🇷 (desarrollo del kernel) Pritam🇮🇳 (funciones de cámara) Matteo🇮🇹 (consejos, ideas y guías generales sobre varias cosas. Muchas gracias por todo) Pablo🇦🇷 (apoyo emocional) Nico Lopez 🇦🇷 (pruebas) LZTEAMPROJECT 🇧🇷 (diseño de la ROM) DevCore🇧🇪 (por la ayuda para iniciar UI8 y arreglo de RIL) ",
