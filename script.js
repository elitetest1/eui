document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            feature1_title: "Elite UI Core",
            feature1_desc: "A powerful in-ROM control center: system monitor, performance modes, CPU/GPU temps, RAM monitor, battery stats, display tuning, and more — all in real time.",
            feature2_title: "Galaxy AI + Offline NPU",
            feature2_desc: "Full Galaxy AI from S25 Series, 3B-parameter NPU model, Samsung LLM 0.40, and offline text tasks, live translation and summaries — no internet required.",
            feature3_title: "Pro Camera — 4K 120fps",
            feature3_desc: "Full Camera2API and RAW support on every lens. 4K 120fps in Pro Video mode. Pro Mode unlocked on the telephoto sensor.",
            feature4_title: "Extreme Privacy",
            feature4_desc: "ATrace, graphics tracing and system logging fully disabled. Secure screenshot, absolute privacy mode, and screenshot/recording detection nuked.",
            ...
            feature6_title: "Elite App Manager",
            feature6_desc: "Disable any system or user app in real-time, with no reboot needed. Full control over your device's installed software — handle with care.",
        ...
        es: {
            ...
            feature1_title: "Elite UI Core",
            feature1_desc: "Un potente panel de control integrado en la ROM: monitor del sistema, modos de rendimiento, temperaturas CPU/GPU, monitor de RAM, estadísticas de batería y ajustes de pantalla, todo en tiempo real.",
            feature2_title: "Galaxy AI + NPU Offline",
            feature2_desc: "Galaxy AI completo de la serie S25, modelo NPU de 3B parámetros, Samsung LLM 0.40 y tareas de texto, traducción en vivo y resúmenes sin conexión a internet.",
            feature3_title: "Cámara Pro — 4K 120fps",
            feature3_desc: "Soporte completo de Camera2API y RAW en todos los lentes. Grabación 4K 120fps en Modo Pro Video. Modo Pro desbloqueado en el sensor telefoto.",
            feature4_title: "Privacidad Extrema",
            feature4_desc: "ATrace, trazado de gráficos y registros del sistema completamente desactivados. Captura segura, modo privacidad absoluta y detección de capturas/grabaciones eliminada.",
            feature5_title: "Floppy Kernel",
            ...
            feature6_title: "Elite App Manager",
            feature6_desc: "Desactiva cualquier app del sistema o de usuario en tiempo real, sin reiniciar. Control total sobre el software instalado en tu dispositivo — úsalo con cuidado.",
        ...
        hi: {
            ...
            feature1_title: "Elite UI Core",
            feature1_desc: "ROM में बना शक्तिशाली कंट्रोल सेंटर: सिस्टम मॉनीटर, परफॉर्मेंस मोड, CPU/GPU तापमान, RAM मॉनीटर, बैटरी आँकड़े और डिस्प्ले ट्यूनिंग — सब रियल-टाइम में।",
            feature2_title: "Galaxy AI + Offline NPU",
            feature2_desc: "S25 सीरीज़ का पूर्ण Galaxy AI, 3B-पैरामीटर NPU मॉडल, Samsung LLM 0.40, और बिना इंटरनेट के टेक्स्ट कार्य, लाइव अनुवाद और सारांश।",
            feature3_title: "Pro कैमरा — 4K 120fps",
            feature3_desc: "हर लेंस पर पूर्ण Camera2API और RAW सपोर्ट। Pro Video मोड में 4K 120fps रिकॉर्डिंग। टेलीफोटो सेंसर पर Pro Mode अनलॉक।",
            feature4_title: "अत्यधिक गोपनीयता",
            feature4_desc: "ATrace, ग्राफिक्स ट्रेसिंग और सिस्टम लॉगिंग पूरी तरह बंद। सुरक्षित स्क्रीनशॉट, परम गोपनीयता मोड, और स्क्रीनशॉट/रिकॉर्डिंग डिटेक्शन हटाया गया।",
            feature5_title: "Floppy Kernel",
            ...
            feature6_title: "Elite App Manager",
            feature6_desc: "बिना रिबूट किए किसी भी सिस्टम या यूज़र ऐप को रियल-टाइम में बंद करें। अपने डिवाइस पर स्थापित सॉफ़्टवेयर पर पूर्ण नियंत्रण — सावधानी से उपयोग करें।",
        ...
        pt: {
            ...
            feature1_title: "Elite UI Core",
            feature1_desc: "Um poderoso painel de controle integrado à ROM: monitor do sistema, modos de desempenho, temperaturas CPU/GPU, monitor de RAM, estatísticas de bateria e ajustes de tela — tudo em tempo real.",
            feature2_title: "Galaxy AI + NPU Offline",
            feature2_desc: "Galaxy AI completo da série S25, modelo NPU com 3B parâmetros, Samsung LLM 0.40, e tarefas de texto, tradução ao vivo e resumos offline — sem internet.",
            feature3_title: "Câmera Pro — 4K 120fps",
            feature3_desc: "Suporte completo a Camera2API e RAW em todas as lentes. Gravação 4K 120fps no modo Pro Video. Modo Pro desbloqueado na lente telefoto.",
            feature4_title: "Privacidade Extrema",
            feature4_desc: "ATrace, rastreamento gráfico e logs do sistema completamente desativados. Captura segura, modo privacidade absoluta e detecção de capturas/gravações removida.",
            feature5_title: "Floppy Kernel",
            ...
            feature6_title: "Elite App Manager",
            feature6_desc: "Desative qualquer app do sistema ou do usuário em tempo real, sem reiniciar. Controle total sobre os aplicativos instalados no seu dispositivo — use com cuidado.",
