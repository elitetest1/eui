document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            feature2_title: "Builded with Proton+",
            feature2_desc: "Upstreamed, undervolted and GPU Overcloked kernel (with stock voltaje for gpu).",
            ...
            credits: "Credits to Tizziano Provenzano 'Elite', SAMSUNG (all) ExtremeROM (commits) @rakeshauthmakedxd, @YACINEGTI, Ronoa Enzo🇦🇷 (testing and help) Ravindu🇱🇰 (tools and general help) Orangecat🇹🇭 (random build.prop tweaks shared in octuber 2024) oevrik🇷🇺 (rom design) ExtremeXT🇷🇴 (for commits) Luminance🇻🇳 (rom design) FPSensor🇦🇷 (kernel dev) Flopster🇦🇷 (kernel dev) Pritam🇮🇳 (Camera features) Matteo🇮🇹 (Tips, ideas, and general guides on various things. Thank you so much for all) Pablo🇦🇷 (emotional support) Nico Lopez 🇦🇷 (testing) LZTEAMPROJECT 🇧🇷 (rom design) DevCore🇧🇪 (for help to boot UI8 and RIL fix) ",
